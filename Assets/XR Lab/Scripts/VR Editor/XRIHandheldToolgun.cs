...
public class XRIHandheldToolgun : MonoBehaviour
{
    ...
    UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable _InteractableBase; //used to reference the interactor that activates the gun
    ...
    void Start()
    {
        ...
        _InteractableBase = GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>();
